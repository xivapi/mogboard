...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _Polyfills__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Polyfills */ \"./assets/js/Polyfills.js\");\n/* harmony import */ var _Polyfills__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_Polyfills__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _Server__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Server */ \"./assets/js/Server.js\");\n/* harmony import */ var _Language__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Language */ \"./assets/js/Language.js\");\n/* harmony import */ var _HeaderUser__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./HeaderUser */ \"./assets/js/HeaderUser.js\");\n/* harmony import */ var _HeaderCategories__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./HeaderCategories */ \"./assets/js/HeaderCategories.js\");\n/* harmony import */ var _HeaderCategoriesSelection__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./HeaderCategoriesSelection */ \"./assets/js/HeaderCategoriesSelection.js\");\n/* harmony import */ var _HeaderSettings__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./HeaderSettings */ \"./assets/js/HeaderSettings.js\");\n/* harmony import */ var _ProductAlert__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./ProductAlert */ \"./assets/js/ProductAlert.js\");\n/* harmony import */ var _Search__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./Search */ \"./assets/js/Search.js\");\n/* harmony import */ var _ProductPricing__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./ProductPricing */ \"./assets/js/ProductPricing.js\");\n/* harmony import */ var _ProductHistory__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./ProductHistory */ \"./assets/js/ProductHistory.js\");\n/* harmony import */ var _ProductCrossWorld__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./ProductCrossWorld */ \"./assets/js/ProductCrossWorld.js\");\n/* harmony import */ var _ProductLoading__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./ProductLoading */ \"./assets/js/ProductLoading.js\");\n //\n// Start\n//\n\n\n_Server__WEBPACK_IMPORTED_MODULE_1__[\"default\"].init();\n\n_Language__WEBPACK_IMPORTED_MODULE_2__[\"default\"].init();\n\n_HeaderUser__WEBPACK_IMPORTED_MODULE_3__[\"default\"].watch();\n\n_HeaderCategories__WEBPACK_IMPORTED_MODULE_4__[\"default\"].watch();\n\n_HeaderCategoriesSelection__WEBPACK_IMPORTED_MODULE_5__[\"default\"].watch();\n\n_HeaderSettings__WEBPACK_IMPORTED_MODULE_6__[\"default\"].watch();\n\n_ProductAlert__WEBPACK_IMPORTED_MODULE_7__[\"default\"].watch();\n\n_Search__WEBPACK_IMPORTED_MODULE_8__[\"default\"].watch();\n\n\n\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ({\n  ProductPricing: _ProductPricing__WEBPACK_IMPORTED_MODULE_9__[\"default\"],\n  ProductHistory: _ProductHistory__WEBPACK_IMPORTED_MODULE_10__[\"default\"],\n  ProductCrossWorld: _ProductCrossWorld__WEBPACK_IMPORTED_MODULE_11__[\"default\"],\n  ProductLoading: _ProductLoading__WEBPACK_IMPORTED_MODULE_12__[\"default\"]\n});\n\n//# sourceURL=webpack://mogboard/./assets/js/App.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nvar ProductAlert =\n/*#__PURE__*/\nfunction () {\n  function ProductAlert() {\n    _classCallCheck(this, ProductAlert);\n\n    this.uiView = $('.product-alert-form');\n    this.uiButton = $('.btn-add-alert');\n  }\n\n  _createClass(ProductAlert, [{\n    key: \"watch\",\n    value: function watch() {\n      var _this = this;\n\n      this.uiButton.on('click', function (event) {\n        _this.uiView.toggleClass('open');\n      });\n      $(document).mouseup(function (event) {\n        var buttons = _this.uiButton;\n        var nav = _this.uiView; // if the target of the click isn't the container nor a descendant of the container\n\n        if (!buttons.is(event.target) && buttons.has(event.target).length === 0 && !nav.is(event.target) && nav.has(event.target).length === 0) {\n          _this.uiView.removeClass('open');\n        }\n      });\n    }\n  }]);\n\n  return ProductAlert;\n}();\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (new ProductAlert());\n\n//# sourceURL=webpack://mogboard/./assets/js/ProductAlert.js?");

/***/ }),

/***/ "./assets/js/ProductCrossWorld.js":
/*!****************************************!*\
  !*** ./assets/js/ProductCrossWorld.js ***!
  \****************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _Server__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Server */ \"./assets/js/Server.js\");\n/* harmony import */ var _Http__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Http */ \"./assets/js/Http.js\");\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n\n\n\nvar ProductCrossWorld =\n/*#__PURE__*/\nfunction () {\n  function ProductCrossWorld() {\n    _classCallCheck(this, ProductCrossWorld);\n\n    this.ui = null;\n  }\n\n  _createClass(ProductCrossWorld, [{\n    key: \"setUi\",\n    value: function setUi(className) {\n      this.ui = $(className);\n      return this;\n    }\n  }, {\n    key: \"fetch\",\n    value: function fetch(itemId, callback) {\n      var _this = this;\n\n      var server = _Server__WEBPACK_IMPORTED_MODULE_0__[\"default\"].getServer();\n      _Http__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getItemPricesCrossWorld(server, itemId, function (response) {\n        _this.ui.html(response);\n\n        callback();\n      });\n    }\n  }]);\n\n  return ProductCrossWorld;\n}();\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (new ProductCrossWorld());\n\n//# sourceURL=webpack://mogboard/./assets/js/ProductCrossWorld.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nvar ProductLoading =\n/*#__PURE__*/\nfunction () {\n  function ProductLoading() {\n    _classCallCheck(this, ProductLoading);\n\n    this.ui = $('.loading-container');\n    this.text = $('.product-loading-bar-text');\n    this.bar = $('.product-loading-bar span');\n    this.active = false;\n  }\n\n  _createClass(ProductLoading, [{\n    key: \"show\",\n    value: function show() {\n      this.active = true;\n      this.ui.addClass('on');\n      return this;\n    }\n  }, {\n    key: \"hide\",\n    value: function hide() {\n      var _this = this;\n\n      this.active = false;\n      this.ui.removeClass('on');\n      this.setInstant().removeLonger().set(0, '');\n      setTimeout(function () {\n        _this.removeInstant();\n\n        _this.removeLonger();\n      }, 50);\n      return this;\n    }\n  }, {\n    key: \"set\",\n    value: function set(percent, text) {\n      this.text.html(text);\n      this.bar.css('width', \"\".concat(percent, \"%\"));\n      return this;\n    }\n  }, {\n    key: \"setText\",\n    value: function setText(text) {\n      if (this.active) {\n        this.text.html(text);\n      }\n\n      return this;\n    }\n  }, {\n    key: \"setLonger\",\n    value: function setLonger() {\n      this.bar.addClass('longer');\n      return this;\n    }\n  }, {\n    key: \"removeLonger\",\n    value: function removeLonger() {\n      this.bar.removeClass('longer');\n      return this;\n    }\n  }, {\n    key: \"setInstant\",\n    value: function setInstant() {\n      this.bar.addClass('instant');\n      return this;\n    }\n  }, {\n    key: \"removeInstant\",\n    value: function removeInstant() {\n      this.bar.removeClass('instant');\n      return this;\n    }\n  }]);\n\n  return ProductLoading;\n}();\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (new ProductLoading());\n\n//# sourceURL=webpack://mogboard/./assets/js/ProductLoading.js?");
